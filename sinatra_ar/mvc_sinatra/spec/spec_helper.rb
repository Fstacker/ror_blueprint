...
module SpecHelper
  ...
  NUMEROLOGY = {
    ...
    "2" => { birthdate: "12161999", message: "TTwo is the mediator and peace-lover.  The number two indicates the desire for harmony.  It is a gentle, considerate, and sensitive vibration.  Ruled by the Moon." },
    ...
    "6" => { birthdate: "12111999", message: "TThis is the peace lover.  The number six is a loving, stable, and harmonious vibration.  Ruled by Venus." },
